...
void mem_system_init(void)
{
	...
	EV_MOD_FLUSH = esim_register_event_with_name(mod_handler_flush,
			mem_domain_index, "mod_nmoesi_flush");
	EV_MOD_FLUSH_FINISH = esim_register_event_with_name(mod_handler_flush,
