...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module ntbl_bitcount_bits_rom (
...
initial begin
    $readmemh("./ntbl_bitcount_bits_rom.dat", ram0);
    $readmemh("./ntbl_bitcount_bits_rom.dat", ram1);
    $readmemh("./ntbl_bitcount_bits_rom.dat", ram2);
    $readmemh("./ntbl_bitcount_bits_rom.dat", ram3);
end
...
ntbl_bitcount_bits_rom ntbl_bitcount_bits_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
