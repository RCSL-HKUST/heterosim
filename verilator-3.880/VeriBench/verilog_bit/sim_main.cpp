...
#include "Vbitcnt.h"		// From Verilating "top.v"
#if VM_TRACE
...
Vbitcnt *top;			// Instantiation of module
...
int main(int argc, char **argv, char **env) {
	...
	top = new Vbitcnt;		// Create instance of module
	...
	top->ap_start = 0;
        ...
        unsigned char out_r_ce0;
        unsigned char out_r_we0;
        unsigned int out_r_d0;
        unsigned char out_r_address1;
        unsigned char out_r_ce1;
        unsigned char out_r_we1;
        unsigned int out_r_d1;
  ...
  {            
                if(out_r_ce0 && out_r_we0)
                      ret[out_r_address0] = out_r_d0;
                if(out_r_ce1 && out_r_we1)
                      ret[out_r_address1] = out_r_d1;                
...

	        {
                      ...
                      out_r_address1 = top->out_r_address1;
                      out_r_ce1 = top->out_r_ce1;
                      out_r_we1 = top->out_r_we1;
                      out_r_d1 = top->out_r_d1; 
		...
		main_time++;		// Time passes...
                ...
                if(top->out_r_ce0 && top->out_r_we0)
                      ret[top->out_r_address0] = top->out_r_d0;
                if(top->out_r_ce1 && top->out_r_we1)
                      ret[top->out_r_address1] = top->out_r_d1;          
