...
#include "Vsha_transform.h"		// From Verilating "top.v"
#if VM_TRACE
...
Vsha_transform *top;			// Instantiation of module
...
int main(int argc, char **argv, char **env) {
	...
	top = new Vsha_transform;		// Create instance of module
	...
	top->ap_start = 0;
        top->m = 84;
        top->n = 20;
        unsigned char y_ce0,y_we0,buff_address0,y_address0,buff_ce0;
        unsigned char y_ce1,y_we1,buff_address1,y_address1,buff_ce1;
        unsigned int y_d0,buff_q0,y_d1,buff_q1;
        buff_ce0=0;
        buff_ce1=0;
        y_ce0=0;
        y_ce1=0;      
  ...
  {             //if ((top->buff_ce0 | top->buff_ce1)&&(!top->ap_clk) )
		...
		if (y_ce1 == 1 && y_we1)
...

	        {
                  ...
                  y_we0 = top->y_we0;
                  y_d0 = top->y_d0;
                  y_address0 = top->y_address0;
                  y_ce1 = top->y_ce1;
                  y_we1 = top->y_we1;
                  y_d1 = top->y_d1;
                  y_address1 = top->y_address1;
		...
		main_time++;		// Time passes...
               ...
               if (top->y_ce0 == 1 && top->y_we0)
                   buf[top->y_address0]= top->y_d0;

		if (top->y_ce1 == 1 && top->y_we1)
		
                         buf[top->y_address1]=top->y_d1;         
