...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module AR_btbl_bitcount_bits_rom (
...
initial begin
    $readmemh("./AR_btbl_bitcount_bits_rom.dat", ram0);
    $readmemh("./AR_btbl_bitcount_bits_rom.dat", ram1);
end
...
AR_btbl_bitcount_bits_rom AR_btbl_bitcount_bits_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
