...
#include "Vdecode_motion_vector.h"		// From Verilating "top.v"
#if VM_TRACE
...
#define ARRAY_SIZE 5
#define array_size 1
#define KERNEL_NAME "decode_motion_vector"

Vdecode_motion_vector *top;			// Instantiation of module
...
int main(int argc, char **argv, char **env) {
	...
	top = new Vdecode_motion_vector;		// Create instance of module
	...
	top->ap_start = 0;
        top->m = 20;
        top->n = 4;
        unsigned char buff_ce0,buff_address0;
        unsigned char buff_ce1,buff_address1;
        unsigned char y_ap_vld;
        unsigned int buff_q0,buff_q1,y;
        buff_ce0=0;
        buff_ce1=0;  
        y_ap_vld = 0;   
