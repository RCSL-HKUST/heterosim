...
#include "Vfloat64_mul.h"		// From Verilating "top.v"
#if VM_TRACE
...
#define ARRAY_SIZE 2
#define array_size 1
#define KERNEL_NAME "float64_mul"

Vfloat64_mul *top;			// Instantiation of module
...
int main(int argc, char **argv, char **env) {
	...
	top = new Vfloat64_mul;		// Create instance of module
