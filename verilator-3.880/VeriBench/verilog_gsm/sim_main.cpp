...
#include "VReflection_coefficients.h"		// From Verilating "top.v"
#if VM_TRACE
...
#define ARRAY_SIZE 9
#define array_size 8
#define KERNEL_NAME "Reflection_coefficients"

VReflection_coefficients *top;			// Instantiation of module
...
int main(int argc, char **argv, char **env) {
	...
	top = new VReflection_coefficients;		// Create instance of module
	...
	tfp->open ("vlt_dump.vcd");	// Open the dump file
        ...
        unsigned char x_ce0 =0;
        unsigned char y_ce0 =0;
        unsigned int x_q0,y_d0;
        unsigned char y_we0,x_address0,y_address0; 
        unsigned int ret;
