...
int main(int argc, char **argv, char **env) {
	...
	top->ap_start = 0;
        ...
        unsigned char Array_r_address0;
        unsigned char Array_r_ce0;
        unsigned char Array_r_we0;
        unsigned int Array_r_d0;
        unsigned int Array_r_q0;
        unsigned char Array_r_address1;
        unsigned char Array_r_ce1;
        unsigned char Array_r_we1;
        unsigned int Array_r_d1;
        unsigned int Array_r_q1;
	...
	while (!top->ap_done && !Verilated::gotFinish()) {
		...
		if (tfp) tfp->dump (main_time);	// Create waveform trace for this timestamp
          ...
          {            
		if (Array_r_ce0 == 1 && !Array_r_we0)
			{top->Array_r_q0 = Array[Array_r_address0];
                         fprintf(ss,"read_0  %d  %d\n", top->Array_r_address0,Array[top->Array_r_address0]); }
		if (Array_r_ce0 == 1 && Array_r_we0)
			{Array[Array_r_address0]= Array_r_d0;
                         fprintf(ss,"write_0  %d  %d\n", top->Array_r_address0, Array[top->Array_r_address0]);}
      		if (Array_r_ce1 == 1 && !Array_r_we1)
			{top->Array_r_q1 = Array[Array_r_address1];
                         fprintf(ss,"read_1  %d  %d\n", top->Array_r_address1,Array[top->Array_r_address1]);  }
		if (Array_r_ce1 == 1 && Array_r_we1)
			{Array[Array_r_address1]= Array_r_d1;
	        ...
	        {
                      Array_r_address0 = top->Array_r_address0;
                     Array_r_ce0  =top->Array_r_ce0;
                    Array_r_we0 =top->Array_r_we0;
                    Array_r_d0 =top->Array_r_d0;

                        Array_r_address1 = top->Array_r_address1;
                     Array_r_ce1 =top->Array_r_ce1;
                    Array_r_we1 =top->Array_r_we1;
                    Array_r_d1 =top->Array_r_d1;
