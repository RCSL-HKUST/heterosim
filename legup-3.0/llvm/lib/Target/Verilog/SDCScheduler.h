 ...
 */
 ...
 private:
     ...
     * in HLS nomenclature.
     *
     * @param instrTypePredicate is a function pointer that returns true if the instruction is of the constrained type
     ...
     */
    void addResourceConstraint(Function *F,
            bool (*instrTypePredicate)(Instruction*), unsigned constraint);
    /**
