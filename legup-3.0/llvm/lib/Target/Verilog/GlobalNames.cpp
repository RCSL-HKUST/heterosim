...
const std::string GlobalNames::verilogReservedKeywords[] = { 
    "and", "always", "assign", "attribute", "begin", "buf", "bufif0", "bufif1",
    "bufif1", "case", "cmos", "deassign", "default", "defparam", "disable", "else",
    "endattribute", "end", "endcase", "endfunction", "endprimitive", "endmodule",
    "endtable", "endtask", "event", "for", "force", "forever", "fork", "function",
    "highhz0", "highhz1", "if", "initial", "inout", "input", "integer", "join",
    "large", "medium", "module", "nand", "negedge", "nor", "not", "notif0",
    "notif1", "nmos", "or", "output", "parameter", "pmos", "posedge", "primitive",
    ...
    "task", "tran", "tranif0", "tranif1", "time", "tri", "triand", "trior",
    "trireg", "tri0", "tri1", "vectored", "wait", "wand", "weak0", "weak1",
    "while", "wire", "wor",
    // SystemVerilog-2005 keywords - these give warnings from Quartus
    "type", "return"
};

void GlobalNames::stripInvalidCharacters(std::string &str) {
    replaceAll(str, ".", "_");
    replaceAll(str, "-", "_");
    replaceAll(str, " ", "_");
    replaceAll(str, "%", "");
...
std::string GlobalNames::verilogName(const Value *val) {
    ...
    static std::set<std::string> verilogReserved(verilogReservedKeywords, verilogReservedKeywords+97);
