...
public:
    ...
    static float getMaxDelay () {
        ...
        // 5 ns ie. 200 Mhz
        //return 5
        return LEGUP_CONFIG->getParameterInt("SDC_PERIOD");
    }
...
public:
    SchedulerDAG () {}
    ~SchedulerDAG();
    bool runOnFunction(Function &F, AliasAnalysis *A, Allocation *alloc);
...
private:
    ...
    bool addDependency(Instruction *inst, Instruction *dep);
