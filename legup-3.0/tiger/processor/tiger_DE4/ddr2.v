// megafunction wizard: %DDR2 High Performance Controller v11.1%
// GENERATION: XML
...
// 			ddr2_controller_phy
// ============================================================
// Generated by DDR2 High Performance Controller 11.1 [Altera, IP Toolbench 1.3.0 Build 259]
// ************************************************************
...
module ddr2 (
	...
	wire [5:0] signal_wire1 = 6'b0;
	wire [5:0] signal_wire2 = 6'b0;
	wire signal_wire3 = 1'b0;
	wire [63:0] signal_wire4 = 64'b0;
	wire [7:0] signal_wire5 = 8'b0;
	...
	wire [3:0] signal_wire14 = 4'b0;
	wire [2:0] signal_wire15 = 3'b0;
	...
	ddr2_controller_phy	ddr2_controller_phy_inst(
		...
		.dqs_offset_delay_ctrl(signal_wire2),
		.hc_scan_enable_access(signal_wire3),
		.hc_scan_enable_dq(signal_wire4),
		.hc_scan_enable_dm(signal_wire5),
		.hc_scan_enable_dqs(signal_wire6),
		.hc_scan_enable_dqs_config(signal_wire7),
		.hc_scan_din(signal_wire8),
		.hc_scan_update(signal_wire9),
		.hc_scan_ck(signal_wire10),
		.pll_reconfig_write_param(signal_wire11),
		.pll_reconfig_read_param(signal_wire12),
		.pll_reconfig(signal_wire13),
		.pll_reconfig_counter_type(signal_wire14),
		.pll_reconfig_counter_param(signal_wire15),
		.pll_reconfig_soft_reset_en_n(signal_wire16),
		.pll_reconfig_data_in(signal_wire17),
		.pll_phasecounterselect(signal_wire18),
		.pll_phaseupdown(signal_wire19),
		.pll_phasestep(signal_wire20),
		.pll_reconfig_enable(signal_wire21),
		.local_autopch_req(signal_wire22),
		.local_self_rfsh_req(signal_wire23),
		.local_multicast_req(signal_wire24),
		.local_refresh_chip(signal_wire25),
...
// Retrieval info: <MEGACORE title="DDR2 SDRAM Controller with ALTMEMPHY"  version="11.1"  build="259"  iptb_version="1.3.0 Build 259"  format_version="120" >
...
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=/home/choijon5/legup/tiger/processor/tiger_DE4/ddr2_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
