...
#create_base_clock -fmax "50 MHz" -target clk clk
#create_base_clock -fmax "100 MHz" -target clk2x clk2x
...
if {$family == "StratixIV"} { 
    ...
    # END
    #============================================================
    #set_global_assignment -name SDC_FILE ddr2/ddr2_phy_ddr_timing.sdc
