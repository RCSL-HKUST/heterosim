 ...
 */
void
decode_block (int comp_no, int *out_buf, int *HuffBuff,char p_jinfo_comps_info_quant_tbl_no_[NUM_COMPONENT],
unsigned int p_jinfo_quant_tbl_quantval_[NUM_QUANT_TBLS][DCTSIZE2],int p_jinfo_dc_dhuff_tbl_ml_[NUM_HUFF_TBLS],
...
int
decode_start ( int *x, int m, int *y, int n
		)

{
   ...
   data_in(x,m,  &p_jinfo_image_height_,
			&p_jinfo_image_width_,
			&p_jinfo_smp_fact_,
  ...
  if (p_jinfo_smp_fact_ == SF1_1_1)
      ...
      decode_start_label12:while (CurrentMCU < p_jinfo_NumMCU_)
	{
	  ...
	  decode_start_label13:for (i = 0; i < 4; i++)
	    {
	      decode_block (0, IDCTBuff[i], HuffBuff[0],   p_jinfo_comps_info_quant_tbl_no_,
	    	      p_jinfo_quant_tbl_quantval_,
	    		  p_jinfo_dc_dhuff_tbl_ml_,
	    		  p_jinfo_dc_dhuff_tbl_maxcode_,
	    		  p_jinfo_dc_dhuff_tbl_mincode_,
	  ...
	  /* Decode U */
	  decode_block (1, IDCTBuff[4], HuffBuff[1],   p_jinfo_comps_info_quant_tbl_no_,
		      p_jinfo_quant_tbl_quantval_,
			  p_jinfo_dc_dhuff_tbl_ml_,
			  p_jinfo_dc_dhuff_tbl_maxcode_,
			  p_jinfo_dc_dhuff_tbl_mincode_,
	  ...
	  /* Decode V */
	  decode_block (2, IDCTBuff[5], HuffBuff[2],   p_jinfo_comps_info_quant_tbl_no_,
		      p_jinfo_quant_tbl_quantval_,
			  p_jinfo_dc_dhuff_tbl_ml_,
			  p_jinfo_dc_dhuff_tbl_maxcode_,
			  p_jinfo_dc_dhuff_tbl_mincode_,
	  ...
	  decode_start_label14:for (i = 0; i < 4; i++)
	    {
    ...
    //data2();
    data_out(x,n,  OutData_image_width_,
